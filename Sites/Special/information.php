...
<body>
    <content>
        <div>
            <?php
                session_start();
                if(isset($_SESSION['completeCreateAccuntInfo']))
                {
                    echo $_SESSION['completeCreateAccuntInfo'];
                    unset($_SESSION['completeCreateAccuntInfo']);
                }
                else
                {
                    if($_SESSION['IsUserLogged'] == false)
                    {
            ...
            ?>
            <br><br>
            <a href="../../index.php"><button>Back login</button></a>
        </div>
    </content>
</body>
</html>